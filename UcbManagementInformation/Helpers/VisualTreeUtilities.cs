...
namespace UcbManagementInformation.Helpers
{
    ...
    {
        /// <summary>
        /// Find parent within visual tree, for example to set z index on canvas
        /// </summary>
        /// <typeparam name="T">Type of object to find</typeparam>
        /// <param name="obj">object to find the parent of</param>
        /// <returns>parent object of generic type</returns>
