...
namespace FirstLook.ServiceModel.DomainServices.Client.Security
{
    ...
    internal abstract class AsyncResultBase : IAsyncResult
    {
        ...
        public static TAsyncResult EndAsyncOperation<TAsyncResult>(IAsyncResult asyncResult, bool cancel) where TAsyncResult : AsyncResultBase
        {
            ...
            {
                throw new ArgumentException("Wrong async result type.", "asyncResult");
            }

            if (asyncResultBase.CancellationRequested)
            {
                throw new InvalidOperationException("This operation was cancelled.");
            }
            ...
            {
                throw new InvalidOperationException("This operation is not complete.");
            }
        ...
        public void Complete()
        {
            lock (this._syncLock)
            {
                ...
                {
                    throw new InvalidOperationException("This method can only be invoked once.");
                }
