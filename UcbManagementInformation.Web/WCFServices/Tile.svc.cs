...
namespace UcbManagementInformation.Web.WCFServices
{
    ...
    public class Tile : ITile
    {
        ...
        /* global parameters */
        private string geomField = "Shape"; // default name of Geography DataType column in tables
        ...
        public Stream GetTile(string table, string quadkey, string thematicstr)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    StringBuilder query = new StringBuilder("SELECT ID," + LayerStyle[table].valueCol + "," + geomField + ".Reduce(@reduce) as " + geomField + " FROM [dbo].[" + table + "] WITH(INDEX(geog_sidx)) WHERE ");
                    ...
                    lvl = quadkey.Length;
                    double reduce = int.Parse(ConfigurationManager.AppSettings["reduceMax"]) - (lvl * 2000);
            ...
            return thisExe.GetManifestResourceStream("UcbManagementInformation.Server.WCFServices.empty.png");
        }
